(function (global, factory) {
    ...
    function customizeNestOptions(id_cols) {
        ...
        this.containers.main.selectAll('#chm-nest-control--3').property('disabled', id_cols.length === 1 ? true : false);
