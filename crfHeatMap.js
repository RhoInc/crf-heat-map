(function (global, factory) {
    ...
    function customizeNestOptions(id_cols) {
        ...
        this.containers.main.select('#chm-nest-control--3').property('disabled', id_cols.length === 1 ? true : false);
        ...
        this.containers.main.select('#chm-nest-control--2').selectAll('option').filter(function (d) {
            return d.label === 'None';
