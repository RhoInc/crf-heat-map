export default function customizeCells() {
    ...
    this.cells
        .attr('class', d => {
            ...
            if (d.col === 'id')
                ...
                if (d.col.indexOf('query') > -1)
                    level = d.text === 0 ? 5 : d.text < 7 ? 4 : d.text < 13 ? 3 : d.text < 19 ? 2 : 1;
                else
                    level = d.text === 1 ? 5 : d.text > .75 ? 4 : d.text > .5 ? 3 : d.text > .25 ? 2 : 1;
        ...
        .text(d => (
            d.col === 'id'
                ? (d.text.indexOf(':') > -1 ? d.text.substring(d.text.lastIndexOf(':') + 1) : d.text.substring(1))
