...
function deriveData() {
    ...
    //Define headers.
    this.export.headers = d3.merge([this.export.nests, this.export.filters, this.config.headers.slice(1)]);

    //Define columns.
    this.export.cols = d3.merge([this.export.nests, this.filters.map(function (filter) {
        return filter.col;
