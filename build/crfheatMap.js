        ...
        if (table.config.id_cols[table.config.id_cols.length - 1] === 'subjectnameoridentifier') {
            ...
            if (table.config.id_cols.length == 1) {
                this.export.data.forEach(function(subject, index, objects) {
                    subject['site'] =
                        subjectmap[Object.values(subject)[Object.values(subject).length - 1]][
                            'site'
                        ];
                    subject['status'] =
                        subjectmap[Object.values(subject)[Object.values(subject).length - 2]][
                            'status'
                        ]; // have to move to -2 to get subject since site was added to array
                    subject['freeze'] =
                        subjectmap[Object.values(subject)[Object.values(subject).length - 3]][
                            'freeze'
                        ];
                });
            }
