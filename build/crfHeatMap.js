...
function addRowDisplayToggle() {
    ...
    expandable_rows.on('click', function (d) {
        ...
        function iterativeCollapse(d) {
            if (d.children) {
                d.children.classed('chm-hidden chm-row--collapsed', true).classed('chm-row--expanded', false);
