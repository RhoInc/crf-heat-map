...
function defineStyles() {
    var styles = ['#crf-heat-map {' + '}', '.chm-column {' + '    display: inline-block;' + '}', '.chm-column > * {' + '    width: 100%;' + '}', '.chm-row {' + '    display: inline-block;' + '}', '.chm-row > * {' + '    display: inline-block;' + '}', '.chm-row--1 {' + '    height: 67px;' + '    padding-bottom: 10px;' + '    border-bottom: 1px solid lightgray;' + '    margin-bottom: 10px;' + '}',
    ...
    '#chm-left-column-row-1 {' + '    position: relative;' + '}', '#chm-nest-label {' + '    float: right;' + '}', '#chm-controls-label {' + '    position: absolute;' + '    bottom: 0;' + '    width: 100%;' + '    text-align: center;' + '    vertical-align: bottom;' + '    font-size: 24px;' + '    font-weight: bold;' + '}',
...
function rendererSettings() {
    return {
        ...
        value_cols: ['is_partial_entry', 'DATA_PAGE_VERIFIED', 'ready_for_freeze', 'is_frozen', 'is_signed', 'is_locked', 'open_query_cnt', 'answer_query_cnt'],
