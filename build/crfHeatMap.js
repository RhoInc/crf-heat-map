        ...
        var loading = setInterval(function () {
            ...
            if (loadingIndicated) {
                ...
                if (changer_this.checked) {
                    ...
                    context.draw(context.data.summarized.filter(function (d) {
                        return d.parents.length == 0;
                    }));
